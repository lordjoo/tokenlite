...
function ajax_form_submit(a = $(".validate-form"), b = !0, c = "ti ti-alert", d = !0) {
    ...
    a.each(function () {
        var a = $(this);
        a.validate({
            errorElement: "span", errorClass: "input-border-error error", submitHandler: function (e) {
                $(e).ajaxSubmit({
                    dataType: "json", success: function (f) {
                        var g = "success" == f.msg ? "ti ti-check" : c;
                        if (btn_actived(a.find("button.save-disabled"), !1), show_toast(f.msg, f.message, g), "success" != f.msg) cl(f); else if (!0 === b && $(e).clearForm(), bs_modal_toggle(a, d), f.link) setTimeout(function () {
                        ...
                        cl(c), show_toast("warning", msg_is_wrong + "\n(" + c + ")", "ti ti-na"), cl("Ajax error!!")
                    }
                })
...
function stick_nav_() {
    var a = $(".is-sticky"), b = $(".topbar"), c = $(".topbar-wrap");
    if (0 < a.length) {
        var d = a.offset();
        $(window).scroll(function () {
            var e = $(window).scrollTop(), f = b.height();
...
function toggle_tigger_() {
    0 < $(".toggle-tigger").length && $(document).on("click", ".toggle-tigger", function (a) {
        ...
        var b = $(".toggle-tigger"), c = $(".toggle-class");
...
function date_time_picker_() {
    var a = $(".date-picker"), b = $(".date-picker-dob"), c = $(".time-picker");
    0 < a.length && a.each(function () {
...
function switch_toggle_() {
    var a = $(".switch-toggle"), b = $(".switch-toggle-link");
    0 < a.length && a.each(function () {
        $(this).on("change", function () {
            var a = $(this), c = a.data("switch");
...
function input_file_() {
    var a = $(".input-file");
    0 < a.length && a.each(function () {
        var a = $(this), b = $(this).next(), c = b.text();
...
function copytoclipboard(a, b, c) {
    var d = document.queryCommandSupported("copy"), e = a, f = b;
...
function datatable_() {
    var a = $(".dt-init");
    0 < a.length && a.each(function () {
        var a = $(this), b = a.data("items") ? a.data("items") : 5;
        a.DataTable({
            ordering: !1,
            autoWidth: !1,
    ...
    0 < b.length && b.each(function () {
        var a = $(this), b = a.data("items") ? a.data("items") : 6, c = a.DataTable({
            ordering: !1,
            autoWidth: !1,
...
function randString(a) {
    var b = $(a).attr("data-character-set").split(","), c = "";
...
(function (a) {
    'use strict';
    var b = a("body"), c = a(document), d = a("#ajax-modal"), e = a(".close-modal"), f = a(".modal-backdrop");
    ...
    var h = window.location.href, i = a(".navbar a");
